...
void fillPage(GeneralPage &page, const std::string &index,
  ...
  auto checkboxColumn = std::make_shared<ColumnLayout>(
      "checkbox_column" + index, 0.3, 0.8, 0.0, 0.0, 0.04, 0.0);
  ...
  auto radioColumn = std::make_shared<ColumnLayout>("radio_column" + index, 0.3,
                                                    0.8, 0.0, 0.0, 0.04, 0.0);
  auto radioContainer1 = std::make_shared<LeafLayout>("radio_container_1", 1.0,
                                                      0.25, 0.0, 0.0, 0.0, 0.0);
  auto radio1 = std::make_shared<RadioButtonWidget<int>>("radio_1",
                                                         radioVariable, "1", 1);
  radioContainer1->setWidget(radio1);
  radioColumn->addChild(radioContainer1);

  auto radioContainer2 = std::make_shared<LeafLayout>("radio_container_2", 1.0,
                                                      0.25, 0.0, 0.0, 0.0, 0.0);
  auto radio2 = std::make_shared<RadioButtonWidget<int>>("radio_2",
                                                         radioVariable, "2", 2);
  radioContainer2->setWidget(radio2);
  radioColumn->addChild(radioContainer2);

  auto radioContainer3 = std::make_shared<LeafLayout>("radio_container_3", 1.0,
                                                      0.25, 0.0, 0.0, 0.0, 0.0);
  auto radio3 = std::make_shared<RadioButtonWidget<int>>("radio_3",
                                                         radioVariable, "3", 3);
