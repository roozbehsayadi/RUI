...
Color::Color(unsigned char r, unsigned char g, unsigned char b, unsigned char alpha) { setColor(r, g, b, alpha); }

void Color::setColor(unsigned char grayAmount) { setColor(grayAmount, grayAmount, grayAmount, 255); }
